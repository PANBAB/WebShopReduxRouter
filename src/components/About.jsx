  ...
  return (
    <Container maxWidth="lg">
      ...
      <Typography variant="body1" sx={{ mb: 4 }}>
        <b>
          Successful chef who went to university and culinary school at the same
          time.<br></br> Now I have a passion for web development and I want to
          show you what I can do. Get a job as well and make a career out of it.
        </b>
      </Typography>
          ...
          <Card sx={{ maxWidth: 345 }}>
            ...
            <CardContent>
              ...
              <Typography variant="body2" color="text.secondary">
                ...
                with me. In a very brief time, managed to climb the ladder from
                a line cook to a chef of some posts, having to organize and
                control small-scale teams.
              </Typography>
            </CardContent>
          </Card>
        </Grid>
          ...
          <Card sx={{ width: 942 }}>
            ...
            <CardContent>
              ...
              <Typography variant="body2" color="text.secondary">
                ...
                continued with getting some experience in React. High competency
                in using React resulted in knowing Recoil and understanding
                Redux.
              </Typography>
            </CardContent>
          </Card>
